    ...
    <aside className="w-64 bg-brand-dark text-white min-h-screen flex flex-col shadow-2xl z-10">
      <div className="p-6 border-b border-blue-900/50">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-blue-500 rounded-lg shadow-sm shadow-blue-500/50">
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group relative overflow-hidden
                ${active 
                  ? 'bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-sm shadow-blue-900/50 translate-x-1' 
