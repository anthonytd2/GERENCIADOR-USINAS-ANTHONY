    ...
    <div className="space-y-8 animate-fade-in-down pb-20">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* FATURAMENTO */}
          <div className="bg-gray-50-card p-6 rounded-lg border border-gray-200 shadow-sm relative overflow-hidden group hover:shadow-sm transition-all">
          ...
          <div className="bg-gray-50-card p-6 rounded-lg border border-gray-200 shadow-sm relative overflow-hidden group hover:shadow-sm transition-all">
            ...
            <div className="flex flex-col h-full justify-between relative z-10">
              ...
              <div className="mt-4 pt-4 border-t border-gray-50 flex items-center justify-between">
                <span className="text-sm text-gray-500 ">Custo Operacional</span>
          ...
          <div className="bg-gradient-to-br from-emerald-500 to-teal-600 p-6 rounded-lg shadow-sm shadow-emerald-200 relative overflow-hidden group text-white">
            ...
            <div className="flex flex-col h-full justify-between relative z-10">
              <div>
                <div className="inline-flex items-center gap-1 bg-gray-50-card/20 text-white px-3 py-1 rounded-full text-xs font-bold mb-4 backdrop-blur-sm border border-white/10">
              ...
              <div className="mt-4 pt-4 border-t border-white/10 flex items-center justify-between">
                <span className="text-sm text-emerald-50 ">Spread</span>
                <div className="w-8 h-8 rounded-full bg-gray-50-card/20 flex items-center justify-center text-white backdrop-blur-md">
                  <DollarSign size={16} />
                </div>
              </div>
            </div>
              ...
              return (
                <div key={index} className="flex flex-col items-center flex-1 group relative z-10 h-full justify-end">
                  ...
                  <div className="w-full max-w-[40px] md:max-w-[60px] flex items-end justify-center relative h-full">
                    ...
                    <div
                      className={`w-2/3 rounded-t-md z-10 relative transition-all duration-1000 ${temValor ? 'bg-gradient-to-t from-emerald-600 to-teal-400 shadow-sm shadow-emerald-200 group-hover:brightness-110' : 'bg-transparent'}`}
