...
export default function DetalheVinculo() {
  ...
  // Carrega APENAS os dados do vínculo (Sem o financeiro que estava travando)
  useEffect(() => {
  ...
  // Helpers para exibir nomes corretamente
  ...
  return (
    <div className="max-w-6xl mx-auto pb-20 space-y-6">
      ...
      {/* CARDS DE INFORMAÇÃO (MANTIDOS COMO VOCÊ PEDIU) */}
      ...
      {/* ÁREA DE AÇÃO: BOTÃO PARA O FINANCEIRO */}
